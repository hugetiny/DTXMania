namespace DTX2WAV
{
	partial class Main
	{
		...
		private void InitializeComponent()
		{
			...
			this.checkBox_overwriteCheck = new System.Windows.Forms.CheckBox();
			...
			this.toolTip1.SetToolTip(this.label_infile, resources.GetString("label_infile.ToolTip"));
			// 
			// groupBox_recfiles
			// 
			...
			this.toolTip1.SetToolTip(this.groupBox_recfiles, resources.GetString("groupBox_recfiles.ToolTip"));
			// 
			...
			this.toolTip1.SetToolTip(this.comboBox_AudioFormat, resources.GetString("comboBox_AudioFormat.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.label_filetype, resources.GetString("label_filetype.ToolTip"));
			// 
			// button_BrowseAudio
			// 
			resources.ApplyResources(this.button_BrowseAudio, "button_BrowseAudio");
			this.button_BrowseAudio.Name = "button_BrowseAudio";
			this.toolTip1.SetToolTip(this.button_BrowseAudio, resources.GetString("button_BrowseAudio.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.textBox_BrowseAudio, resources.GetString("textBox_BrowseAudio.ToolTip"));
			// 
			// label_outfile
			// 
			resources.ApplyResources(this.label_outfile, "label_outfile");
			this.label_outfile.Name = "label_outfile";
			this.toolTip1.SetToolTip(this.label_outfile, resources.GetString("label_outfile.ToolTip"));
			// 
			// button_browseDTX
			// 
			resources.ApplyResources(this.button_browseDTX, "button_browseDTX");
			this.button_browseDTX.Name = "button_browseDTX";
			this.toolTip1.SetToolTip(this.button_browseDTX, resources.GetString("button_browseDTX.ToolTip"));
			...
			this.textBox_BrowseDTX.AllowDrop = true;
			this.textBox_BrowseDTX.Name = "textBox_BrowseDTX";
			this.toolTip1.SetToolTip(this.textBox_BrowseDTX, resources.GetString("textBox_BrowseDTX.ToolTip"));
			this.textBox_BrowseDTX.DragDrop += new System.Windows.Forms.DragEventHandler(this.textBox_BrowseDTX_DragDrop);
			this.textBox_BrowseDTX.DragEnter += new System.Windows.Forms.DragEventHandler(this.textBox_BrowseDTX_DragEnter);
			// 
			// tabControl1
			// 
			...
			this.tabPage1.Controls.Add(this.checkBox_overwriteCheck);
			...
			// 
			// checkBox_overwriteCheck
			// 
			resources.ApplyResources(this.checkBox_overwriteCheck, "checkBox_overwriteCheck");
			this.checkBox_overwriteCheck.Name = "checkBox_overwriteCheck";
			this.toolTip1.SetToolTip(this.checkBox_overwriteCheck, resources.GetString("checkBox_overwriteCheck.ToolTip"));
			this.checkBox_overwriteCheck.UseVisualStyleBackColor = true;
			// 
			// button_Cancel
			// 
			...
			this.toolTip1.SetToolTip(this.button_Convert, resources.GetString("button_Convert.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.groupBox_volumes, resources.GetString("groupBox_volumes.ToolTip"));
			// 
			...
			this.toolTip1.SetToolTip(this.checkBox_MonitorSound, resources.GetString("checkBox_MonitorSound.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.numericUpDown_Master, resources.GetString("numericUpDown_Master.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.trackBar_Master, resources.GetString("trackBar_Master.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.numericUpDown_Bass, resources.GetString("numericUpDown_Bass.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.trackBar_Bass, resources.GetString("trackBar_Bass.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.numericUpDown_Guitar, resources.GetString("numericUpDown_Guitar.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.trackBar_Guitar, resources.GetString("trackBar_Guitar.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.numericUpDown_Drums, resources.GetString("numericUpDown_Drums.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.trackBar_Drums, resources.GetString("trackBar_Drums.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.numericUpDown_SE, resources.GetString("numericUpDown_SE.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.trackBar_SE, resources.GetString("trackBar_SE.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.numericUpDown_BGM, resources.GetString("numericUpDown_BGM.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.trackBar_BGM, resources.GetString("trackBar_BGM.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.groupBox_MP3, resources.GetString("groupBox_MP3.ToolTip"));
			// 
			// comboBox_MP3_bps
			// 
			...
			this.toolTip1.SetToolTip(this.comboBox_MP3_bps, resources.GetString("comboBox_MP3_bps.ToolTip"));
			// 
			// label11
			// 
			...
			this.toolTip1.SetToolTip(this.groupBox_Ogg, resources.GetString("groupBox_Ogg.ToolTip"));
			// 
			// label_highq
			// 
			resources.ApplyResources(this.label_highq, "label_highq");
			this.label_highq.Name = "label_highq";
			this.toolTip1.SetToolTip(this.label_highq, resources.GetString("label_highq.ToolTip"));
			// 
			// label_ogg_lowq
			// 
			resources.ApplyResources(this.label_ogg_lowq, "label_ogg_lowq");
			this.label_ogg_lowq.Name = "label_ogg_lowq";
			this.toolTip1.SetToolTip(this.label_ogg_lowq, resources.GetString("label_ogg_lowq.ToolTip"));
			// 
			// numericUpDown_Ogg_Q
			// 
			...
			this.toolTip1.SetToolTip(this.numericUpDown_Ogg_Q, resources.GetString("numericUpDown_Ogg_Q.ToolTip"));
			...
			this.toolTip1.SetToolTip(this.trackBar_Ogg_Q, resources.GetString("trackBar_Ogg_Q.ToolTip"));
		...
		private System.Windows.Forms.CheckBox checkBox_overwriteCheck;
	}
}
