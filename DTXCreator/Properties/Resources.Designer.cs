...
namespace DTXCreator.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   This is not MIDI Import Settings file. に類似しているローカライズされた文字列を検索します。
        /// </summary>
        internal static string strMIDIインポート設定ファイルではないMSG {
            get {
                return ResourceManager.GetString("strMIDIインポート設定ファイルではないMSG", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string strMIDIインポート設定ファイル保存ダイアログのタイトル {
            get {
                return ResourceManager.GetString("strMIDIインポート設定ファイル保存ダイアログのタイトル", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Select MIDI Import Settings File に類似しているローカライズされた文字列を検索します。
        /// </summary>
        internal static string strMIDIインポート設定ファイル選択ダイアログのタイトル {
            get {
                return ResourceManager.GetString("strMIDIインポート設定ファイル選択ダイアログのタイトル", resourceCulture);
            }
        }
        
        /// <summary>
        ///   MIDI Import Settings Files (*.xml)|*.xml|All files (*.*)|*.* に類似しているローカライズされた文字列を検索します。
        /// </summary>
        internal static string strMIDIインポート設定ファイル選択ダイアログのフィルタ {
            get {
                return ResourceManager.GetString("strMIDIインポート設定ファイル選択ダイアログのフィルタ", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Calculating DGB levels に類似しているローカライズされた文字列を検索します。
        /// </summary>
        internal static string str難易度計算マン計算中 {
            get {
                return ResourceManager.GetString("str難易度計算マン計算中", resourceCulture);
            }
        }
