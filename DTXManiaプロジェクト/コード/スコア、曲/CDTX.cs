...
//		public bool bBASS演奏で直前のBASSを消音する;
		...
		private CDTX()
		{
			...
			STGDAPARAM[] stgdaparamArray = new STGDAPARAM[] {		// GDA->DTX conversion table
				new STGDAPARAM("TC", Ech定義.BPM),
				new STGDAPARAM("BL", Ech定義.BarLength),
				new STGDAPARAM("GS", Ech定義.flowspeed_gt_nouse),
				new STGDAPARAM("DS", Ech定義.flowspeed_dr_nouse),
				new STGDAPARAM("FI", Ech定義.FillIn),
				new STGDAPARAM("HH", Ech定義.HiHatClose),
				new STGDAPARAM("SD", Ech定義.Snare),
				new STGDAPARAM("BD", Ech定義.BassDrum),
				new STGDAPARAM("HT", Ech定義.HighTom),
				new STGDAPARAM("LT", Ech定義.LowTom),
				new STGDAPARAM("CY", Ech定義.Cymbal),
				new STGDAPARAM("G1", Ech定義.Guitar_xxB),
				new STGDAPARAM("G2", Ech定義.Guitar_xGx),
				new STGDAPARAM("G3", Ech定義.Guitar_xGB),
				new STGDAPARAM("G4", Ech定義.Guitar_Rxx),
				new STGDAPARAM("G5", Ech定義.Guitar_RxB),
				new STGDAPARAM("G6", Ech定義.Guitar_RGx),
				new STGDAPARAM("G7", Ech定義.Guitar_RGB),
				new STGDAPARAM("GW", Ech定義.Guitar_Wailing),
				new STGDAPARAM("01", Ech定義.SE01),
				new STGDAPARAM("02", Ech定義.SE02),
				new STGDAPARAM("03", Ech定義.SE03),
				new STGDAPARAM("04", Ech定義.SE04),
				new STGDAPARAM("05", Ech定義.SE05),
				new STGDAPARAM("06", Ech定義.SE06),
				new STGDAPARAM("07", Ech定義.SE07),
				new STGDAPARAM("08", Ech定義.SE08),
				new STGDAPARAM("09", Ech定義.SE09),
				new STGDAPARAM("0A", Ech定義.SE10),
				new STGDAPARAM("0B", Ech定義.SE11),
				new STGDAPARAM("0C", Ech定義.SE12),
				new STGDAPARAM("0D", Ech定義.SE13),
				new STGDAPARAM("0E", Ech定義.SE14),
				new STGDAPARAM("0F", Ech定義.SE15),
				new STGDAPARAM("10", Ech定義.SE16),
				new STGDAPARAM("11", Ech定義.SE17),
				new STGDAPARAM("12", Ech定義.SE18),
				new STGDAPARAM("13", Ech定義.SE19),
				new STGDAPARAM("14", Ech定義.SE20),
				new STGDAPARAM("15", Ech定義.SE21),
				new STGDAPARAM("16", Ech定義.SE22),	
				new STGDAPARAM("17", Ech定義.SE23),
				new STGDAPARAM("18", Ech定義.SE24),
				new STGDAPARAM("19", Ech定義.SE25),
				new STGDAPARAM("1A", Ech定義.SE26),
				new STGDAPARAM("1B", Ech定義.SE27),
				new STGDAPARAM("1C", Ech定義.SE28),
				new STGDAPARAM("1D", Ech定義.SE29),
				new STGDAPARAM("1E", Ech定義.SE30),
				new STGDAPARAM("1F", Ech定義.SE31),
				new STGDAPARAM("20", Ech定義.SE32),
				new STGDAPARAM("B1", Ech定義.Bass_xxB),
				new STGDAPARAM("B2", Ech定義.Bass_xGx),
				new STGDAPARAM("B3", Ech定義.Bass_xGB),
				new STGDAPARAM("B4", Ech定義.Bass_Rxx),
				new STGDAPARAM("B5", Ech定義.Bass_RxB),
				new STGDAPARAM("B6", Ech定義.Bass_RGx),
				new STGDAPARAM("B7", Ech定義.Bass_RGB),
				new STGDAPARAM("BW", Ech定義.Bass_Wailing),
				new STGDAPARAM("G0", Ech定義.Guitar_Open),
				new STGDAPARAM("B0", Ech定義.Bass_Open)
			};
			...
			this.n使用レーン数 = new STDGBVALUE<int>();
		...
		{
			this.tチップの再生(rChip, n再生開始システム時刻ms, nLane, CDTXMania.Instance.ConfigIni.n自動再生音量, false, false);
		}
			...
			if (pChip.n整数値_内部番号 >= 0)
			{
				...
				if (this.listWAV.ContainsKey(pChip.n整数値_内部番号))
				{
					...
					if (sound != null)
					{
						...
						sound.db再生速度 = ((double)CDTXMania.Instance.ConfigIni.n演奏速度) / 20.0;
		...
		private struct STGDAPARAM
		{
			...
			public Ech定義 eDTXのチャンネル番号;

			public STGDAPARAM(string strGDAのチャンネル文字列, Ech定義 eDTXのチャンネル番号)		// 2011.1.1 yyagi 構造体のコンストラクタ追加(初期化簡易化のため)
			{
