			...
			switch (n現在の選択行)
			{
				case (int)EOrder.Title:
					this.act曲リスト.t曲リストのソート(
						CDTXMania.app.Songs管理.t曲リストのソート2_タイトル順, eInst, nSortOrder
					);
					this.act曲リスト.t選択曲が変更された(true);
					break;
				case (int)EOrder.Level:
					this.act曲リスト.t曲リストのソート(
						CDTXMania.app.Songs管理.t曲リストのソート4_LEVEL順, eInst, nSortOrder,
				...
				case (int)EOrder.BestRank:
					this.act曲リスト.t曲リストのソート(
						CDTXMania.app.Songs管理.t曲リストのソート5_BestRank順, eInst, nSortOrder,
						this.act曲リスト.n現在のアンカ難易度レベル
					);
					break;
				case (int)EOrder.PlayCount:
					...
					this.act曲リスト.t曲リストのソート(
						CDTXMania.app.Songs管理.t曲リストのソート3_演奏回数の多い順, eInst, nSortOrder,
						this.act曲リスト.n現在のアンカ難易度レベル
					);
					this.act曲リスト.t選択曲が変更された(true);
					break;
				case (int)EOrder.Author:
					this.act曲リスト.t曲リストのソート(
						CDTXMania.app.Songs管理.t曲リストのソート8_アーティスト名順, eInst, nSortOrder,
						this.act曲リスト.n現在のアンカ難易度レベル
					);
					this.act曲リスト.t選択曲が変更された(true);
					break;
				case (int)EOrder.SkillPoint:
					this.act曲リスト.t曲リストのソート(
						CDTXMania.app.Songs管理.t曲リストのソート6_SkillPoint順, eInst, nSortOrder,
						this.act曲リスト.n現在のアンカ難易度レベル
					);
					this.act曲リスト.t選択曲が変更された(true);
					break;
						...
						this.act曲リスト.t曲リストのソート(
							CDTXMania.app.Songs管理.t曲リストのソート9_BPM順, eInst, nSortOrder,
							this.act曲リスト.n現在のアンカ難易度レベル
						);
					this.act曲リスト.t選択曲が変更された(true);
						break;
				...
				case (int)EOrder.Date:
					this.act曲リスト.t曲リストのソート(
						CDTXMania.app.Songs管理.t曲リストのソート7_更新日時順, eInst, nSortOrder,
						this.act曲リスト.n現在のアンカ難易度レベル
					);
					this.act曲リスト.t選択曲が変更された(true);
					break;
