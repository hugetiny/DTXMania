...
namespace DTXMania
{
	...
	public class CWailngChip_Guitar_Drum画面 : CWailingChip共通
	{
			...
			: base()
		{
			...
			drawX = (CDTXMania.app.ConfigIni.eドラムレーン表示位置 == Eドラムレーン表示位置.Left) ? 1764 : 1764 - 71;	// ウェイリングチップ描画位置X座標: 4種全て異なる値
	...
	public class CWailngChip_Bass_Drum画面 : CWailingChip共通
	{
			...
			: base()
		{
			...
			drawX = (CDTXMania.app.ConfigIni.eドラムレーン表示位置 == Eドラムレーン表示位置.Left) ? 1437 : 1437 - 994;	// ウェイリングチップ描画位置X座標: 4種全て異なる値
