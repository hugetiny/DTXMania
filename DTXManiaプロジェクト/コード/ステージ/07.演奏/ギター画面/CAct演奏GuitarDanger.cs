				...
				//	this.bDanger中[nPart] = bIsDanger[nPart];
					if ( bIsDanger[ nPart ] )
					{
						if ( this.txDANGER != null )
						{
							...
							//this.txDANGER.t2D描画( CDTXMania.Instance.app.Device, 0x12a, ( i * 0x80 ) + num2, this.rc領域[ 0 ] );
							//this.txDANGER.t2D描画( CDTXMania.Instance.app.Device, 0x12a, ( ( i * 0x80 ) + num2 ) + 0x40, this.rc領域[ 1 ] );
						}
						//				}
					}
				}
