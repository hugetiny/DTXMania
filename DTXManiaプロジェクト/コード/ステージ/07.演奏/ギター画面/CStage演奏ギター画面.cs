...
//			}
		...
		public override int On進行描画()
		{
			if( !base.b活性化してない )
			{
				...
				{
//					bool flag3 = ( CDTXMania.Instance.ConfigIni.bAutoPlay.Guitar || !CDTXMania.Instance.DTX.bチップがある.Guitar ) || ( this.actGauge.db現在のゲージ値.Guitar <= -0.1 );				// #23630
//					bool flag4 = ( CDTXMania.Instance.ConfigIni.bAutoPlay.Bass || !CDTXMania.Instance.DTX.bチップがある.Bass ) || ( this.actGauge.db現在のゲージ値.Bass <= -0.1 );					// #23630
		...
		protected override void t進行描画_Wailing枠()
		{
			...
			base.t進行描画_Wailing枠(
				...
				yG,
				yB
				//CDTXMania.Instance.ConfigIni.bReverse.Guitar ? 340 : 11,
				//CDTXMania.Instance.ConfigIni.bReverse.Bass ?   340 : 11
			);
		}
				...
				if ( !pChip.bHit && pChip.b可視 )
				{
					...
					if ( ( y > 0 ) && ( y < 409 ) )
					{
						if ( this.txチップ != null )
						{
							...
							{
								{
									...
									this.txチップ.t2D描画( CDTXMania.Instance.app.Device, xo, y - 4, new Rectangle( 0, 192 + ( ( nアニメカウンタ現在の値 % 5 ) * 8 ), 103, 8 ) );
								}
							}
							...
							if ( bChipHasR )
							{
								this.txチップ.t2D描画( CDTXMania.Instance.app.Device, x, y - 4, rc );
							}
							rc.X += 32;
							if ( bChipHasG )
							{
				...
				if ( !pChip.bHit && pChip.b可視 )
				{
					...
					if ( ( num8 > 0 ) && ( num8 < 0x199 ) )
					{
						...
						if ( pChip.nチャンネル番号 == 160 )
						{
							if ( this.txチップ != null )
							{
								this.txチップ.t2D描画( CDTXMania.Instance.app.Device, 480, num8 - 4, new Rectangle( 0, 0xc0 + ( ( num9 % 5 ) * 8 ), 0x67, 8 ) );
							}
						}
						else if ( !configIni.bLeft.Bass )
						{
							...
							{
								this.txチップ.t2D描画( CDTXMania.Instance.app.Device, 480, num8 - 4, rectangle3 );
							}
							rectangle3.X += 0x20;
							if ( ( ( pChip.nチャンネル番号 & 2 ) != 0 ) && ( this.txチップ != null ) )
							{
								this.txチップ.t2D描画( CDTXMania.Instance.app.Device, 0x204, num8 - 4, rectangle3 );
							}
							rectangle3.X += 0x20;
							if ( ( ( pChip.nチャンネル番号 & 1 ) != 0 ) && ( this.txチップ != null ) )
							{
								this.txチップ.t2D描画( CDTXMania.Instance.app.Device, 0x228, num8 - 4, rectangle3 );
							}
						}
						else
						{
							...
							if ( ( ( pChip.nチャンネル番号 & 4 ) != 0 ) && ( this.txチップ != null ) )
							{
								this.txチップ.t2D描画( CDTXMania.Instance.app.Device, 0x228, num8 - 4, rectangle4 );
							}
							rectangle4.X += 0x20;
							if ( ( ( pChip.nチャンネル番号 & 2 ) != 0 ) && ( this.txチップ != null ) )
							{
								this.txチップ.t2D描画( CDTXMania.Instance.app.Device, 0x204, num8 - 4, rectangle4 );
							}
							rectangle4.X += 0x20;
							if ( ( ( pChip.nチャンネル番号 & 1 ) != 0 ) && ( this.txチップ != null ) )
							{
								this.txチップ.t2D描画( CDTXMania.Instance.app.Device, 480, num8 - 4, rectangle4 );
							}
						}
					}
				}
