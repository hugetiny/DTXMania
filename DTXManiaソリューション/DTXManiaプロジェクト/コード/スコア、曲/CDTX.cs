...
namespace DTXMania
{
	internal class CDTX : CActivity
	{
		...
		public void tギターとベースのランダム化( E楽器パート part, Eランダムモード eRandom )
		{
			...
			{
				int[,] numArray = new int[ , ] { { 0, 1, 2, 3, 4, 5, 6, 7 }, { 0, 2, 1, 3, 4, 6, 5, 7 }, { 0, 1, 4, 5, 2, 3, 6, 7 }, { 0, 2, 4, 6, 1, 3, 5, 7 }, { 0, 4, 1, 5, 2, 6, 3, 7 }, { 0, 4, 2, 6, 1, 5, 3, 7 } };
				int num = -10000;
				int num2 = 0;
				int num3 = 0;
				foreach( CChip chip in this.listChip )
				{
					...
					int num6;
					bool flag;
					if( ( chip.n発声位置 / 0x180 ) != num )
					{
						num = chip.n発声位置 / 0x180;
						num2 = CDTXMania.Random.Next( 6 );
					}
					int num4 = chip.nチャンネル番号;
					if( ( ( ( part != E楽器パート.GUITAR ) || ( 0x20 > num4 ) ) || ( num4 > 0x27 ) ) && ( ( ( part != E楽器パート.BASS ) || ( 160 > num4 ) ) || ( num4 > 0xa7 ) ) )
					{
						continue;
					}
					switch( eRandom )
					{
						case Eランダムモード.RANDOM:
							chip.nチャンネル番号 = ( num4 & 240 ) | numArray[ num2, num4 & 7 ];
							goto Label_02C4;

						case Eランダムモード.SUPERRANDOM:
							chip.nチャンネル番号 = ( num4 & 240 ) | numArray[ CDTXMania.Random.Next( 6 ), num4 & 7 ];
							goto Label_02C4;

						case Eランダムモード.HYPERRANDOM:
							num5 = num4 & 7;
							num6 = 0;
							flag = ( ( part == E楽器パート.GUITAR ) && this.bチップがある.OpenGuitar ) || ( ( part == E楽器パート.BASS ) && this.bチップがある.Bass );
							if( ( ( num5 != 1 ) && ( num5 != 2 ) ) && ( num5 != 4 ) )
							{
								break;
							}
							num6 = CDTXMania.Random.Next( 6 ) + 1;
							goto Label_02B2;
					...
					switch( num5 )
					{
						...
						case 5:
						case 6:
							num6 = flag ? CDTXMania.Random.Next( 8 ) : ( CDTXMania.Random.Next( 7 ) + 1 );
							goto Label_02B2;
						...
						default:
							if( num5 == 7 )
							{
								if( flag )
								{
									int num7 = CDTXMania.Random.Next( 100 );
									if( num7 < 30 )
									{
										num6 = 0;
									}
								...
								{
									int num8 = CDTXMania.Random.Next( 100 );
									if( num8 < 60 )
									{
										num6 = 7;
									}
